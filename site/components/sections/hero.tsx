...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="select-none whitespace-nowrap font-display text-[22vw] font-black uppercase leading-none tracking-tighter text-fg/[0.025]"
        >
          ASWIN
        </span>
      </div>
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-[1fr_1.2fr] md:gap-0">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <a
              href="#projects"
              className="group inline-flex h-11 items-center gap-2 rounded-sm bg-accent px-6 font-mono text-xs font-medium uppercase tracking-[0.14em] text-white transition-all hover:bg-accent-strong"
            >
              View projects
            ...
            <a
              ...
              download
              className="inline-flex h-11 items-center gap-2 rounded-sm border border-border-strong bg-bg-elev px-5 font-mono text-xs uppercase tracking-[0.14em] text-fg-muted transition-all hover:border-accent/40 hover:text-fg"
            >
